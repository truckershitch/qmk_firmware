...
DEBUG is chatty, with messages that are useful for debugging,
INFO is for messages that are useful for users, 
ERROR is for messages that signal an error, and
NONE is used for production builds and emits no messages.
